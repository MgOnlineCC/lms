...
if(@$_SESSION['admin'] || @$_SESSION['pengajar']) {
    ...
    <body>
                ...
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        ...
                        if(@$_SESSION['admin']) {
                            ?>
                            <li>
                                <a href="#"><i class="fa fa-sitemap"></i> Manajemen</a>
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="?page=pengajar" class="<?php if(@$_GET['page'] == 'pengajar') { echo 'active-menu'; } ?>"><i class="fa fa-circle"></i> Manajemen Pengajar</a>
                                    </li>
                                    <li>
                                        <a href="?page=siswa" class="<?php if(@$_GET['page'] == 'siswa') { echo 'active-menu'; } ?>"><i class="fa fa-circle"></i> Manajemen Siswa</a>
                                    </li>
                                    <li>
                                        <a href="?page=siswaregistrasi" class="<?php if(@$_GET['page'] == 'siswaregistrasi') { echo 'active-menu'; } ?>"><i class="fa fa-circle"></i> Registrasi Siswa</a>
                                    </li>
                                </ul>
                            </li>
                            <?php
        ...
        <footer style="padding-left: 20px;"><p> &copy; 2021 E-Learning SMA Pasundan 1 Bandung</p></footer>
    </body>
    </html>
    <?php
} else {
