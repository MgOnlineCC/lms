      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          ...
          <div class="pull-right" >
            <div class="dropdown">
              <button class="btn btn-warning dropdown-toggle btn-xs" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-expanded="true">
        ...
        <div class="notice-board">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <span class="label label-primary"><?php echo tgl_indo($data_berita_detail['tgl_posting']); ?></span>
              <hr />
              <div>
