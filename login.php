...
<body>
    <header>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    Anda belum punya akun ? Silahkan  <a href="./?hal=daftar" class="btn btn-xs btn-warning"><b>Daftar<b></a>
                    </div>
                </div>
            </div>
        </header>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <form method="post">
                                ...
                                <input type="password" name="pass" class="form-control mb-4" required />
                                <br>
